			...
			<div class="main-header">
							...
							<div class="dropdown profile-dropdown">
								<a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
									...
									<span class="avatar avatar-sm online">
										<img src="{{asset('assets/img/profiles/no-img.jpg')}}" alt="Img" class="img-fluid rounded-circle">
									</span>
								</a>
								<div class="dropdown-menu shadow-none">
									<div class="card mb-0">
										<div class="card-header">
											<div class="d-flex align-items-center">
												<span class="avatar avatar-lg me-2 avatar-rounded">
													<img src="{{asset('assets/img/profiles/no-img.jpg')}}" alt="img">
												</span>
												<div>
													...
													@endif
													<p class="fs-12 fw-medium mb-0"><a href="#" class="__cf_email__" data-cfemail="98eff9eaeafdf6d8fde0f9f5e8f4fdb6fbf7f5">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
										...
										<div class="card-footer">
											<a class="dropdown-item d-inline-flex align-items-center p-0 py-2" onclick="$('#nb-global-spinner').fadeIn();" href="{{route('logout')}}">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a class="dropdown-item" onclick="$('#nb-global-spinner').fadeIn();" href="{{route('logout')}}">Logout</a>
					</div>
				</div>
				<!-- /Mobile Menu -->
