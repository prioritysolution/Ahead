        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h2 class="mb-1">Working Calendar</h2>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Yearly Calender</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card flex-fill border-primary attendance-bg">
                        <div class="card-header justify-content-between">
                            <div class="card-title text-center">
                                <h4 class="fw-medium text-gray-5 mb-1" style="font-weight: 900 !important;">Working Calendar
                                </h4>
                            </div>
                        </div>
                        <div class="card-body">
...
@endsection
@push('script')
    <script src="{{ asset('assets/js/payroll/yearcal.js') }}"></script>
@endpush
