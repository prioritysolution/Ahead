        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h2 class="mb-1">Leave Initialization</h2>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Leave Entitlement Initialization</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card flex-fill border-primary attendance-bg">
                        <div class="card-header justify-content-between">
                            <div class="card-title text-center">
                                <h4 class="fw-medium text-gray-5 mb-1" style="font-weight: 900 !important;">Leave Initialization
                                </h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    <label for="selectYear" class="form-label">Select Financial Year</label>
                                    <div class="d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
                                        <select name="selectYear" id="selectYear" class="select2 form-control">
                                ...
                                <div class="col-md-12 d-flex justify-content-center align-items-center gap-3 mb-3">
                                    <button type="button" id="save_btn" class="btn btn-success px-4"
                                        onclick="proc_lev_init();">
...
@endsection
@push('script')
    <script src="{{ asset('assets/js/payroll/leave_init.js') }}"></script>
@endpush
