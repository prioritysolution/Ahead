                    ...
                    <div class="card flex-fill border-primary attendance-bg">
                        <div class="card-header justify-content-between">
                            <div class="card-title text-center">
                                <h4 class="fw-medium text-gray-5 mb-1" style="font-weight: 900 !important;">Deductions
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="selectType" class="form-label">Deduction Name</label>
                                    <div class="d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
                                        <select name="selectType" id="selectType" class="select2 form-control"
                                            ...
                                            <option value="" Selected Disabled>Select Deduction Name</option>
                                            @foreach ($ded_list as $list)
                        ...
                        <div class="card-body d-flex">
                            <div class="border border-primary rounded p-3">
                                <div class="row">
                                    <input type="hidden" id="ded_id" name="ded_id">
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Deduction Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Deduction Name"
                                            autocomplete="off" id="ded_name" name="ded_name">
                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Amount</label>
                                        <input type="text" class="form-control only-numbers" placeholder="Enter Amount" maxlength="5"
                                            autocomplete="off" id="ded_amt" name="ded_amt">
                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Percentage</label>
                                        <input type="text" class="form-control only-decimal" placeholder="Enter Percentage"
                                            maxlength="5" autocomplete="off" id="ded_perc" name="ded_perc">
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control only-numbers" placeholder="Enter Round Off Nearest"
                                            maxlength="5" autocomplete="off" id="ded_round" name="ded_round">
                                    </div>
...
@endsection
@push('script')
    <script src="{{ asset('assets/js/payroll/emp_ded.js') }}"></script>
@endpush
